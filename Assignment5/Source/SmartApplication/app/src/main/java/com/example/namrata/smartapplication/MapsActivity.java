...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        android.location.LocationListener userCurrentLocationListener = new android.location.LocationListener() {
            @Override
        ...
        userCurrentLocation.requestLocationUpdates(LocationManager.GPS_PROVIDER,
                0, 0, (android.location.LocationListener) userCurrentLocationListener);
        ...
        try {
            List<android.location.Address> addresses = geocoder.getFromLocation(latitute, longitude, 1);
        ...
        mMap.addMarker(new MarkerOptions().position(userCurrentLocationCorodinates)
                ...
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.nam)));
